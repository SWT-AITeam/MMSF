...
class Config(object):
    ...
    def _get_path(self, root_path):
        ...
        # self.bert_base = os.path.join(root_path, 'bert/bert-base-cased')
        self.bert_base = os.path.join(root_path, 'bert/bert-base-chinese')
        self.bert_base_case = os.path.join(root_path, 'bert/bert-base-chinese')
        # self.bert_base_case = os.path.join(root_path, 'bert/bert-base-uncased')


        #data pic
        self.data_pic_path = os.path.join(root_path, 'data/')

        # vecpath
        self.vec_path = os.path.join(root_path, 'data/')
